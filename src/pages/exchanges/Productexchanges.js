...
import Dropdown from '../../assets/Imagejs/Dropdown'
import Search from '../../assets/Imagejs/Search'
...
function Productexchanges() {
    ...
    return (
        ...
        <div className="left_panel">
          ...
          <div className="input_box">
              <input className="input_field" type="search" placeholder="searchassets."/>
              <Search/>
          </div>
          ...
          <div className="Markets">
           ...
           <div className="right_panel">
             <span className="Trending_gainers"><b>Trending</b>gainers</span>
             <div className="Today">
               <span>Today</span>
               <Dropdown/>
             </div>
